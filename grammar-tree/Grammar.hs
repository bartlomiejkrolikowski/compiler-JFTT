...
data HappyAbsSyn 
	...
	| HappyAbsSyn9 (Condition)
	| HappyAbsSyn10 (Value)
	| HappyAbsSyn11 (Identifier)
...
happyReduction_1 (_ `HappyStk`
	...
	happyRest)
	 = HappyAbsSyn4
		 (Program (Just happy_var_2) happy_var_4
	) `HappyStk` happyRest
...
happyReduction_3 (HappyTerminal (Pidentifier happy_var_3))
	...
	(HappyAbsSyn5  happy_var_1)
	 =  HappyAbsSyn5
		 (happy_var_1 ++ [Variable happy_var_3]
	)
...
happyReduction_4 (_ `HappyStk`
	...
	happyRest)
	 = HappyAbsSyn5
		 (happy_var_1 ++ [Array happy_var_3 happy_var_5 happy_var_7]
	) `HappyStk` happyRest
...
happyReduction_6 (_ `HappyStk`
	...
	happyRest)
	 = HappyAbsSyn5
		 ([Array happy_var_1 happy_var_3 happy_var_5]
	) `HappyStk` happyRest
...
happyReduction_33 (_ `HappyStk`
	...
	happyRest)
	 = HappyAbsSyn11
		 (ArrVar happy_var_1 happy_var_3
	) `HappyStk` happyRest
...
happyReduction_34 (_ `HappyStk`
	...
	happyRest)
	 = HappyAbsSyn11
		 (ArrNum happy_var_1 happy_var_3
	) `HappyStk` happyRest
